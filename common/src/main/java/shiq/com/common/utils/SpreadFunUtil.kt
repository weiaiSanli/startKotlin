...
//使用DSL扩展Arouter的单个跳转降级错误NavigationCallback
inline fun navigationCallback(navigationCallback: NavigationCallbackDsl.() -> Unit): NavigationCallback {
    return NavigationCallbackDsl().apply(navigationCallback)
}
